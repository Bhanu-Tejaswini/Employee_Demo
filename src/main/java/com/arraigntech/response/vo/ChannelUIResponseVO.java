 ...
 *
 */
public class ChannelUIResponseVO {
	...
	private UpdateTitleEntity updateTitle;
	...
	public UpdateTitleEntity getUpdateTitle() {
		return updateTitle;
	}

	public void setUpdateTitle(UpdateTitleEntity updateTitle) {
	...
	public ChannelUIResponseVO(String username, ChannelTypeProvider type, String channelId, Object streamName,
			Object primaryUrl, Object backupUrl, boolean active, String accessToken, String facebookUserId,
			UpdateTitleEntity updateTitle) {
		super();
		this.username = username;
		this.type = type;
		this.channelId = channelId;
