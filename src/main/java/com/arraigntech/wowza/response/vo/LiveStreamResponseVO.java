...
public class LiveStreamResponseVO {
	...
	private StreamSourceConnectionInformationVO source_connection_information;
	@JsonProperty("direct_playback_urls")
	private DirectPlaybackUrlsVO direct_playback_urls;
	...
	public DirectPlaybackUrlsVO getDirect_playback_urls() {
		return direct_playback_urls;
	}

	public void setDirect_playback_urls(DirectPlaybackUrlsVO direct_playback_urls) {
	...
	public StreamSourceConnectionInformationVO getSource_connection_information() {
		return source_connection_information;
	}

	public void setSource_connection_information(StreamSourceConnectionInformationVO source_connection_information) {
