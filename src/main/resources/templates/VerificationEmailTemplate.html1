...
<html lang="en">
  ...
  <body>
    <section class="verification-sec">
      <div class="verification-body">
        ...
        <h2 class="mt-2 mb-5">Dear ${userMail}</h2>
        <p class="mb-5">
          Please confirm your email address by clicking the button below. This
          confirms that your email address is correct so that we can use it to
          help you recover your password in the future.
        </p>
        <div>
          <a href="${regisrationLink}">
            <button>Confirm Email Address</button>
          </a>
        </div>
        <div class="mb-4">
          <a
            href="${regisrationLink}"></a
          >
        </div>
        <div>
          <p>Thanks,</p>
